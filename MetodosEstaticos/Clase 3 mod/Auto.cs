...
namespace Clase3
{
    class Auto
    {
	   ...
	   public Auto(Rueda ruedaDD, Rueda ruedaID) : this(ruedaDD)
	   {
		   this.RuedaID = ruedaID;
	   }
	   
	   public Auto(Rueda ruedaDD, Rueda ruedaID, Rueda ruedaDT) : this(ruedaDD, ruedaID)
	   {
		   this.RuedaDT = ruedaDT;
	   }
		
	   public Auto(Rueda ruedaDD, Rueda ruedaID, Rueda ruedaDT, Rueda ruedaIT) : this(ruedaDD, ruedaID, ruedaDT)
	   {
