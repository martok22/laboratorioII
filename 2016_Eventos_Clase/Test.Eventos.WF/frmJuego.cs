    ...
    public partial class frmJuego : Form
    {
        ...
        private void txtNumero_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            if (e.KeyCode == Keys.Enter)
            {
                ...
                this.lblPista.Text = this._juego.Pista;
            }
        ...
        {
            this.lblIntentos.Text = "Intentos " + this._juego.CantidadIntentos + "/" + this._juego.CantidadIntentosMax;
        ...
        private void ProximoAGanar(int numero)
        {
            MessageBox.Show("Estás a " + numero + "de ganar");
        }
